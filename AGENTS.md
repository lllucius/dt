...
Historical targets such as Windows, macOS, IOS, OSF/Tru64, VxWorks, MS-DOS, Windows CE, Solaris/SPARC, ARM7, MIPS, old PowerPC Mac, and iPAQ Linux may be inventoried, documented, or quarantined behind explicit legacy options, but they must not be deleted or broadly rewritten without explicit approval.
